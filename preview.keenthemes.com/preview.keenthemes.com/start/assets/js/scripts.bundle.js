...
var KTDialer = function(e, t) {
    ...
    if (e) {
        var i = {
            ...
            s = function() {
                n.value = parseFloat(n.inputElement.value.replace(/[^\d.]/g, "")), n.value < n.options.min && (n.value = n.options.min), n.value > n.options.max && (n.value = n.options.max), n.inputElement.value = u(n.value)
            },
            u = function(e) {
            ...
            return function(t, n, i, a) {
                if (!0 === KTUtil.data(t).has(n)) {
                    ...
                    if (e[n] && e[n][o]) {
                        var r = e[n][o];
                        if (r.name === n) {
                            if (1 != r.one) return r.callback.call(this, i, a);
                            if (0 == r.fired) return e[n][o].fired = !0, r.callback.call(this, i, a)
                        }
                    }
                }
                return null
...
var KTFeedback = function(e) {
    ...
    a(), t.show = function() {
        return function() {
            if (!1 !== KTEventHandler.trigger(t.element, "kt.feedback.show", t)) return "popup" === t.options.type && r(), KTEventHandler.trigger(t.element, "kt.feedback.shown", t), t
        }()
    }, t.hide = function() {
        return function() {
...
var KTImageInput = function(e, t) {
    ...
    if (null != e) {
        var i = {
            ...
            a = function() {
                n.options = KTUtil.deepExtend({}, i, t), n.uid = KTUtil.getUniqueId("imageinput"), n.element = e, n.inputElement = KTUtil.find(e, 'input[type="file"]'), n.wrapperElement = KTUtil.find(e, ".image-input-wrapper"), n.cancelElement = KTUtil.find(e, '[data-kt-imageinput-action="cancel"]'), n.removeElement = KTUtil.find(e, '[data-kt-imageinput-action="remove"]'), n.hiddenElement = KTUtil.find(e, 'input[type="hidden"]'), n.src = KTUtil.css(n.wrapperElement, "backgroundImage"), o(), KTUtil.data(n.element).set("imageinput", n)
            },
            o = function() {
                KTUtil.addEvent(n.inputElement, "change", r), KTUtil.addEvent(n.cancelElement, "click", l), KTUtil.addEvent(n.removeElement, "click", s)
            },
            r = function(e) {
        ...
        !0 === KTUtil.data(e).has("imageinput") ? n = KTUtil.data(e).get("imageinput") : a(), n.getInputElement = function() {
...
KTImageInput.getInstance = function(e) {
    return null !== e && KTUtil.data(e).has("imageinput") ? KTUtil.data(e).get("imageinput") : null
...
var KTMenu = function(e, t) {
    ...
    if (null != e) {
        var i = {
            ...
            o = function(e) {
                null !== e && (!0 === m(e) ? l(e) : r(e))
            },
            r = function(e) {
                null !== e && !0 !== m(e) && ("dropdown" === v(e) ? b(e) : "accordion" === v(e) && S(e), KTUtil.data(e).set("type", v(e)))
            },
            l = function(e) {
                null !== e && !1 !== m(e) && ("dropdown" === v(e) ? E(e) : "accordion" === v(e) && x(e))
            },
            s = function(e) {
                if (!1 !== f(e)) {
                    var t = g(e);
            ...
            b = function(e) {
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.show", e)) {
                    ...
                    var t = g(e),
                        ...
                        r = KTUtil.getHighestZindex(e);
                    null !== r && r >= o && (o = r + 1), o > 0 && KTUtil.css(t, "z-index", o), null !== i && KTUtil.css(t, "width", i), null !== a && KTUtil.css(t, "height", a), KTUtil.css(t, "display", ""), KTUtil.css(t, "overflow", ""), w(e, t), KTUtil.addClass(e, "show"), KTUtil.addClass(e, "menu-dropdown"), KTUtil.addClass(t, "show"), !0 === A(e, "overflow") ? (document.body.appendChild(t), KTUtil.data(e).set("sub", t), KTUtil.data(t).set("item", e), KTUtil.data(t).set("menu", n)) : KTUtil.data(t).set("item", e), KTEventHandler.trigger(n.element, "kt.menu.dropdown.shown", e)
                }
            },
            E = function(e) {
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.hide", e)) {
                    var t = g(e);
                    KTUtil.css(t, "z-index", ""), KTUtil.css(t, "width", ""), KTUtil.css(t, "height", ""), KTUtil.removeClass(e, "show"), KTUtil.removeClass(e, "menu-dropdown"), KTUtil.removeClass(t, "show"), !0 === A(e, "overflow") && (e.classList.contains("menu-item") ? e.appendChild(t) : KTUtil.insertAfter(n.element, e), KTUtil.data(e).remove("sub"), KTUtil.data(t).remove("item"), KTUtil.data(t).remove("menu")), y(e), KTEventHandler.trigger(n.element, "kt.menu.dropdown.hidden", e)
                }
            },
            w = function(e, t) {
                var n, i = A(e, "attach");
            ...
            k = function(e) {
                ...
                return {
                    placement: t,
                    strategy: !0 === A(e, "overflow") ? "absolute" : "fixed",
                    modifiers: [{
                        name: "offset",
                        options: {
                            offset: o
            ...
            C = function(e) {
                ...
                if (i && i.length > 0)
                    for (var a = 0, o = i.length; a < o; a++) t = i[a], "accordion" === v(t) && t !== e && !1 === e.contains(t) && !1 === t.contains(e) && x(t)
            },
            A = function(e, t) {
                var n, i = null;
        ...
        !0 === KTUtil.data(e).has("menu") ? n = KTUtil.data(e).get("menu") : a(), n.click = function(e, t) {
            return function(e, t) {
                t.preventDefault();
                var n = T(e);
                "click" === A(n, "trigger") && (!1 === A(n, "toggle") ? r(n) : o(n))
            }(e, t)
        }, n.link = function(e, t) {
            ...
            return function(e, t) {
                ...
                if (null !== n && "dropdown" === v(n) && (l(n), i.length > 0))
                    for (var a = 0, o = i.length; a < o; a++) null !== i[a] && "dropdown" === v(i[a]) && l(tems[a])
            }(e)
        }, n.mouseover = function(e, t) {
            return function(e, t) {
                var n = T(e);
                null !== n && "hover" === A(n, "trigger") && ("1" === KTUtil.data(n).get("hover") && (clearTimeout(KTUtil.data(n).get("timeout")), KTUtil.data(n).remove("hover"), KTUtil.data(n).remove("timeout")), r(n))
            }(e)
...
KTMenu.getInstance = function(e) {
    ...
    if (t && t.length > 0)
        for (var n = 0, i = t.length; n < i; n++) {
            var a = t[n],
                o = KTMenu.getInstance(a);
            o && "dropdown" === o.getItemSubType(a) && (e ? !1 === o.getItemSubElement(a).contains(e) && !1 === a.contains(e) && a !== e && o.hide(a) : o.hide(a))
        }
    ...
    document.addEventListener("click", (function(e) {
        ...
        if (a && a.length > 0)
            for (var o = 0, r = a.length; o < r; o++)
                if (t = a[o], (i = KTMenu.getInstance(t)) && "dropdown" === i.getItemSubType(t)) {
...
var KTOffcanvas = function(e, t) {
    ...
    if (null != e) {
        var a = {
            ...
            o = function() {
                n.options = KTUtil.deepExtend({}, a, t), n.uid = KTUtil.getUniqueId("offcanvas"), n.element = e, n.overlayElement = null, n.name = n.element.getAttribute("data-kt-offcanvas-name"), n.shown = !1, n.lastWidth, n.toggleElement = null, r(), c(), KTUtil.data(n.element).set("offcanvas", n)
            },
            r = function() {
                var e = f("toggle"),
                    t = f("close");
            ...
            l = function() {
                !1 !== KTEventHandler.trigger(n.element, "kt.offcanvas.toggle", n) && (!0 === n.shown ? s() : u(), KTEventHandler.trigger(n.element, "kt.offcanvas.toggled", n))
            },
            s = function() {
                !1 !== KTEventHandler.trigger(n.element, "kt.offcanvas.hide", n) && (n.shown = !1, m(), i.removeAttribute("data-kt-offcanvas-" + n.name, "on"), i.removeAttribute("data-kt-offcanvas"), KTUtil.removeClass(n.element, n.options.baseClass + "-on"), null !== n.toggleElement && KTUtil.removeClass(n.toggleElement, "active"), KTEventHandler.trigger(n.element, "kt.offcanvas.after.hidden", n))
            },
            u = function() {
                !1 !== KTEventHandler.trigger(n.element, "kt.offcanvas.show", n) && (n.shown = !0, d(), i.setAttribute("data-kt-offcanvas-" + n.name, "on"), i.setAttribute("data-kt-offcanvas", "on"), KTUtil.addClass(n.element, n.options.baseClass + "-on"), null !== n.toggleElement && KTUtil.addClass(n.toggleElement, "active"), KTEventHandler.trigger(n.element, "kt.offcanvas.shown", n))
            },
            c = function() {
                var e = String(f("width"));
                !0 === KTUtil.hasClass(n.element, n.options.baseClass + "-on") && "on" === String(i.getAttribute("data-kt-offcanvas-" + n.name + "-")) ? n.shown = !0 : n.shown = !1, !0 === f("activate") ? (KTUtil.addClass(n.element, n.options.baseClass), KTUtil.addClass(n.element, n.options.baseClass + "-" + p()), KTUtil.css(n.element, "width", e, !0), "left" === p() ? KTUtil.css(n.element, "left", "-" + e) : KTUtil.css(n.element, "right", "-" + e), n.lastWidth = e) : (KTUtil.css(n.element, "width", ""), KTUtil.css(n.element, "right", ""), KTUtil.css(n.element, "left", ""), KTUtil.removeClass(n.element, n.options.baseClass), KTUtil.removeClass(n.element, n.options.baseClass + "-" + p()), s())
            },
            d = function() {
            ...
            f = function(e) {
                if (!0 === n.element.hasAttribute("data-kt-offcanvas-" + e)) {
                    var t = n.element.getAttribute("data-kt-offcanvas-" + e),
            ...
            p = function() {
                return "left" === String(f("direction")) ? "left" : "right"
            };
        KTUtil.data(e).has("offcanvas") ? n = KTUtil.data(e).get("offcanvas") : o(), n.toggle = function() {
            return l()
        }, n.show = function() {
            return u()
        }, n.hide = function() {
...
KTOffcanvas.getInstance = function(e) {
    return null !== e && KTUtil.data(e).has("offcanvas") ? KTUtil.data(e).get("offcanvas") : null
}, KTOffcanvas.createInstances = function(e) {
    var t = document.getElementsByTagName("BODY")[0].querySelectorAll(e);
    if (t && t.length > 0)
        for (var n = 0, i = t.length; n < i; n++) new KTOffcanvas(t[n])
}, window.addEventListener("resize", (function() {
    var e = document.getElementsByTagName("BODY")[0];
    KTUtil.throttle(undefined, (function() {
        var t = e.querySelectorAll('[data-kt-offcanvas="true"]');
        if (t && t.length > 0)
            for (var n = 0, i = t.length; n < i; n++) KTOffcanvas.getInstance(t[n]).update()
    }), 200)
})), KTOffcanvas.init = function() {
    KTOffcanvas.createInstances('[data-kt-offcanvas="true"]')
}, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTOffcanvas.init) : KTOffcanvas.init(), "undefined" != typeof module && void 0 !== module.exports && (module.exports = KTOffcanvas);
    ...
    if (e) {
        var i = {
            ...
            r = function() {
                var e = 0,
                    t = m();
                !0 === l() && (e += t), !0 === n.options.checkUppercase && !0 === s() && (e += t), !0 === n.options.checkLowercase && !0 === u() && (e += t), !0 === n.options.checkDigit && !0 === c() && (e += t), !0 === n.options.checkChar && !0 === d() && (e += t), n.score = e, f()
            },
            l = function() {
            ...
            f = function() {
                var e = [].slice.call(n.highlightElement.querySelectorAll("div")),
                    ...
                    o = g();
                e.map((function(e) {
                    i++, a * i * (n.checkSteps / t) <= o ? e.classList.add("active") : e.classList.remove("active")
                }))
            },
            p = function() {
...
var KTScroll = function(e, t) {
    ...
    if (e) {
        var i = {
            ...
            a = function() {
                n.options = KTUtil.deepExtend({}, i, t), n.element = e, n.id = n.element.getAttribute("id"), r(), KTUtil.data(n.element).set("scroll", n)
            },
            o = function() {
            ...
            r = function() {
                var e, t, i;
                !0 === u("activate") || !1 === n.element.hasAttribute("data-kt-scroll-activate") ? (e = l(), t = u("max-height"), i = u("min-height"), null !== e && e.length > 0 ? KTUtil.css(n.element, "height", e) : KTUtil.css(n.element, "height", ""), null !== t && t.length > 0 ? KTUtil.css(n.element, "max-height", t) : KTUtil.css(n.element, "max-height", ""), null !== i && i.length > 0 ? KTUtil.css(n.element, "min-height", i) : KTUtil.css(n.element, "min-height", ""), !0 === u("save-state") && void 0 !== KTCookie && n.id ? n.element.addEventListener("scroll", o) : n.element.removeEventListener("scroll", o), function() {
                    if (!0 === u("save-state") && void 0 !== KTCookie && n.id && KTCookie.get(n.id + "st")) {
                        var e = parseInt(KTCookie.get(n.id + "st"));
                        e > 0 && (n.element.scrollTop = e)
                    }
                }()) : (KTUtil.css(n.element, "height", ""), KTUtil.css(n.element, "max-height", ""), KTUtil.css(n.element, "min-height", ""), n.element.removeEventListener("scroll", o))
            },
            l = function() {
                var e = u("height");
...
var KTScrolltop = function(e, t) {
    ...
    if (null != e) {
        var a = {
            ...
            o = function() {
                n.options = KTUtil.deepExtend({}, a, t), n.uid = KTUtil.getUniqueId("scrolltop"), n.element = e, r(), KTUtil.data(n.element).set("scrolltop", n)
            },
            r = function() {
...
var KTSearch = function(e, t) {
    ...
    if (e) {
        var i = {
            ...
            a = function() {
                n.options = KTUtil.deepExtend({}, i, t), n.processing = !1, n.element = e, n.contentElement = v("content"), n.formElement = v("form"), n.inputElement = v("input"), n.spinnerElement = v("spinner"), n.clearElement = v("clear"), n.toggleElement = v("toggle"), n.submitElement = v("submit"), n.resultsElement = v("results"), n.suggestionElement = v("suggestion"), n.emptyElement = v("empty"), n.layout = g("layout"), "menu" === n.layout ? n.menuObject = new KTMenu(n.contentElement) : n.menuObject = null, m(), o(), KTUtil.data(n.element).set("search", n)
            },
            o = function() {
                n.inputElement.addEventListener("focus", r), n.inputElement.addEventListener("blur", l), !0 === g("keypress") && n.inputElement.addEventListener("input", u), n.submitElement && n.submitElement.addEventListener("click", c), !0 === g("enter") && n.inputElement.addEventListener("keypress", s), n.clearElement && n.clearElement.addEventListener("click", d), n.menuObject && (n.toggleElement && (n.toggleElement.addEventListener("click", f), n.menuObject.on("kt.menu.dropdown.show", (function(e) {
            ...
            c = function() {
                !1 === n.processing && (n.spinnerElement && n.spinnerElement.classList.remove("d-none"), n.clearElement && n.clearElement.classList.add("d-none"), n.inputElement.focus(), n.processing = !0, KTEventHandler.trigger(n.element, "kt.search.process", n))
            },
            d = function() {
                !1 !== KTEventHandler.trigger(n.element, "kt.search.clear", n) && (n.inputElement.value = "", n.inputElement.focus(), n.clearElement && n.clearElement.classList.add("d-none"), !1 === g("show-on-focus") && p(), KTEventHandler.trigger(n.element, "kt.search.cleared", n))
            },
            m = function() {
                if ("menu" === n.layout) {
                    var e = T();
        ...
        !0 === KTUtil.data(e).has("search") ? n = KTUtil.data(e).get("search") : a(), n.show = function() {
            ...
            return n.spinnerElement && n.spinnerElement.classList.add("d-none"), n.clearElement && n.clearElement.classList.remove("d-none"), 0 === n.inputElement.value.length && d(), n.inputElement.focus(), f(), void(n.processing = !1)
        }, n.clear = function() {
            return d()
...
var KTStepper = function(e, t) {
    ...
    if (null != e) {
        var i = {
            ...
            a = function() {
                n.options = KTUtil.deepExtend({}, i, t), n.uid = KTUtil.getUniqueId("stepper"), n.element = e, n.steps = KTUtil.findAll(n.element, '[data-kt-stepper-element="nav"]'), n.btnNext = KTUtil.find(n.element, '[data-kt-stepper-action="next"]'), n.btnPrevious = KTUtil.find(n.element, '[data-kt-stepper-action="previous"]'), n.btnSubmit = KTUtil.find(n.element, '[data-kt-stepper-action="submit"]'), n.totalStepsNumber = n.steps.length, n.passedStepIndex = 0, n.currentStepIndex = 1, n.options.startingStepIndex > 1 && o(n.options.startingStepIndex), KTUtil.addEvent(n.btnNext, "click", (function(e) {
                    ...
                    if (e.PreviousentDefault(), n.steps && n.steps.length > 0)
                        for (var t = 0, i = n.steps.length; t < i; t++) {
                            if (n.steps[t] === this) return void("next" === m(t + 1) ? KTEventHandler.trigger(n.element, "kt.stepper.next", n) : KTEventHandler.trigger(n.element, "kt.stepper.Previousious", n))
                        }
                })), KTUtil.data(n.element).set("stepper", n)
            },
            o = function(e) {
                if (KTEventHandler.trigger(n.element, "kt.stepper.change", n), !(e === n.currentStepIndex || e > n.totalStepsNumber || e < 0)) return e = parseInt(e), n.passedStepIndex = n.currentStepIndex, n.currentStepIndex = e, r(), KTEventHandler.trigger(n.element, "kt.stepper.changed", n), n
            },
            r = function() {
                var e = "";
                ...
                if (t && t.length > 0)
                    for (var i = 0, a = t.length; i < a; i++) {
                        var o = t[i],
                            r = KTUtil.index(o) + 1;
                        if (KTUtil.removeClass(o, "current"), KTUtil.removeClass(o, "completed"), KTUtil.removeClass(o, "pending"), r == n.currentStepIndex) {
                            if (KTUtil.addClass(o, "current"), !1 !== n.options.animation && "content" == o.getAttribute("data-kt-stepper-element")) {
                                ...
                                var u = "previous" === m(n.passedStepIndex) ? n.options.animationPreviousClass : n.options.animationNextClass;
                                KTUtil.animateClass(o, u)
                            }
                        } else r < n.currentStepIndex ? KTUtil.addClass(o, "completed") : KTUtil.addClass(o, "pending")
                    }
            },
            l = function() {
        ...
        !0 === KTUtil.data(e).has("stepper") ? n = KTUtil.data(e).get("stepper") : a(), n.goTo = function() {
            return o()
...
var KTSticky = function(e, t) {
    ...
    if (null != e) {
        var a = {
            ...
            o = function() {
                n.element = e, n.options = KTUtil.deepExtend({}, a, t), n.uid = KTUtil.getUniqueId("sticky"), n.name = n.element.getAttribute("data-kt-sticky-name"), n.attributeName = "data-kt-sticky-" + n.name, n.eventTriggerState = !0, n.lastScrollTop = 0, window.addEventListener("scroll", r), r(), KTUtil.data(n.element).set("sticky", n)
            },
            r = function(e) {
                var t, a = u("offset"),
                    o = u("reverse");
                !1 !== a && (a = parseInt(a), t = KTUtil.getScrollTop(), !0 === o ? (t > a && n.lastScrollTop < t ? (!1 === i.hasAttribute(n.attributeName) && (l(), i.setAttribute(n.attributeName, "on")), !0 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.on", n), n.eventTriggerState = !1)) : (!0 === i.hasAttribute(n.attributeName) && (s(), i.removeAttribute(n.attributeName)), !1 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.off", n), n.eventTriggerState = !0)), n.lastScrollTop = t) : t > a ? (!1 === i.hasAttribute(n.attributeName) && (l(), i.setAttribute(n.attributeName, "on")), !0 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.on", n), n.eventTriggerState = !1)) : (!0 === i.hasAttribute(n.attributeName) && (s(), i.removeAttribute(n.attributeName)), !1 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.off", n), n.eventTriggerState = !0)))
            },
            l = function(e) {
                var t = u("top"),
                    i = u("left"),
                    a = (u("right"), u("width")),
                    o = u("zindex");
                if (!0 !== e && !0 === u("animation") && (KTUtil.css(n.element, "animationDuration", u("animationSpeed")), KTUtil.animateClass(n.element, "animation " + u("animationClass"))), null !== o && (KTUtil.css(n.element, "z-index", o), KTUtil.css(n.element, "position", "fixed")), null !== t && KTUtil.css(n.element, "top", t), null !== a) {
                    if (a.target) {
                        var r = document.querySelector(a.target);
                        r && (a = KTUtil.css(r, "width"))
                    }
    ...
    return {
        ...
        triggerEvent: function(e, t) {
            ...
            if (e.dispatchEvent) {
                ...
                var a = "change" != t;
                (o = n.createEvent(i)).initEvent(t, a, !0), o.synthetic = !0, e.dispatchEvent(o, !0)
            } else if (e.fireEvent) {
                var o;
        ...
        children: function(e, t, n) {
            ...
            for (var i = [], a = 0, o = e.childNodes.length; a < o; ++a) 1 == e.childNodes[a].nodeType && KTUtil.matches(e.childNodes[a], t, n) && i.push(e.childNodes[a]);
            return i
        },
        ...
        animate: function(e, t, n, i, a, o) {
            var r = {};
            if (r.linear = function(e, t, n, i) {
                    return n * e / i + t
                }, a = r.linear, "number" == typeof e && "number" == typeof t && "number" == typeof n && "function" == typeof i) {
                ...
                l((function r(c) {
                    var d = (c || +new Date) - u;
                    d >= 0 && i(a(d, e, s, n)), d >= 0 && d >= n ? (i(t), o()) : l(r)
                }))
            }
        },
        ...
        slide: function(e, t, n, i, a) {
            if (!(!e || "up" == t && !1 === KTUtil.visible(e) || "down" == t && !0 === KTUtil.visible(e))) {
                ...
                var o = KTUtil.actualHeight(e),
                    r = !1,
                    l = !1;
                KTUtil.css(e, "padding-top") && !0 !== KTUtil.data(e).has("slide-padding-top") && KTUtil.data(e).set("slide-padding-top", KTUtil.css(e, "padding-top")), KTUtil.css(e, "padding-bottom") && !0 !== KTUtil.data(e).has("slide-padding-bottom") && KTUtil.data(e).set("slide-padding-bottom", KTUtil.css(e, "padding-bottom")), KTUtil.data(e).has("slide-padding-top") && (r = parseInt(KTUtil.data(e).get("slide-padding-top"))), KTUtil.data(e).has("slide-padding-bottom") && (l = parseInt(KTUtil.data(e).get("slide-padding-bottom"))), "up" == t ? (e.style.cssText = "display: block; overflow: hidden;", r && KTUtil.animate(0, r, n, (function(t) {
                ...
                }))) : "down" == t && (e.style.cssText = "display: block; overflow: hidden;", r && KTUtil.animate(0, r, n, (function(t) {
        ...
        on: function(e, t, n, i) {
            if (null !== e) {
                ...
                return window.KTUtilDelegatedEventHandlers[a] = function(n) {
                    for (var a = e.querySelectorAll(t), o = n.target; o && o !== e;) {
                        for (var r = 0, l = a.length; r < l; r++) o === a[r] && i.call(o, n);
                        o = o.parentNode
                    }
        ...
        animateClass: function(e, t, n) {
            ...
            for (var o in a) void 0 !== e.style[o] && (i = a[o]);
            KTUtil.addClass(e, "animated " + t), KTUtil.one(e, i, (function() {
                KTUtil.removeClass(e, "animated " + t)
            })), n && KTUtil.one(e, i, n)
        },
        ...
        scrollTo: function(e, t, n) {
            n = n || 500;
            var i, a, o = e ? KTUtil.offset(e).top : 0;
            t && (o -= t), i = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0, a = o, KTUtil.animate(i, a, n, (function(e) {
        ...
        changeColor: function(e, t) {
            ...
            o > 255 ? o = 255 : o < 0 && (o = 0);
            var r = (255 & i) + t;
            return r > 255 ? r = 255 : r < 0 && (r = 0), (n ? "#" : "") + (r | o << 8 | a << 16).toString(16)
        },
        ...
        parseJson: function(e) {
            if ("string" == typeof e) {
                var t = (e = e.replaceAll("'", '"')).replace(/(\w+:)|(\w+ :)/g, (function(e) {
        ...
        getResponsiveValue: function(e, t) {
            ...
            if ("object" == typeof(e = KTUtil.parseJson(e))) {
                var a, o, r = -1;
                for (var l in e)(o = "default" === l ? 0 : this.getBreakpoint(l) ? this.getBreakpoint(l) : parseInt(l)) <= i && o > r && (a = l, r = o);
                n = a ? e[a] : e
            } else n = e;
            return n
        },
...
var KTApp = function() {
    ...
    return {
        init: function() {
            this.initPageLoader(), this.initBootstrapTooltips(), this.initBootstrapPopovers(), this.initScrollSpy(), this.initButtons(), this.initCheck(), this.initSelect2(), this.initCountUp(), this.initAutosize()
        },
        ...
        initCountUp: function() {
            e(), window.addEventListener("scroll", e), [].slice.call(document.querySelectorAll('[data-kt-countup-tabs="true"][data-bs-toggle="tab"]')).map((function(t) {
...
var KTLayoutSidebar = function() {
    var e = function(e, t, n, i) {
        ...
        if (a) {
            ...
            !0 === i && (r.render(), l = !0), s.addEventListener("shown.bs.tab", (function(e) {
                0 == l && (r.render(), l = !0)
            }))
        }
    };
