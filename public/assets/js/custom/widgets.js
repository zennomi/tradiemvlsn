        ...
        init: function() {
            ...
            ! function() {
                ...
                if (t) {
                    ...
                    theme: "snow"
                }), (a = document.querySelector("#kt_forms_widget_2_input")) && autosize(a),
                function() {
                    var t = document.querySelector("#kt_forms_widget_3_input");
                    t && autosize(t)
                }(),
                function() {
                    var t = document.querySelector("#kt_forms_widget_4_input");
                    t && autosize(t)
                }(),
                function() {
